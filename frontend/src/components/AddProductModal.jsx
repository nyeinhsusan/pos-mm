...
const AddProductModal = ({ isOpen, onClose, onProductAdded }) => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      // NOTE: We keep previewImage (local base64) so user can still see their selection
      // The form will still have the old image or none
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    // Wait for image upload to complete if uploading
    if (uploadingImage) {
